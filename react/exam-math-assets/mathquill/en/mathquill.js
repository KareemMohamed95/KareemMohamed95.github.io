...
function addNthRootSymbol(){
  if(lastFocusedMQ == null)return;
  MQ.MathField(document.getElementById(lastFocusedMQ)).write("{\\left(\\right)}^{\\frac{1}{3}}");
  MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
 } 
...
function addSinSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).write("\\sin\\left(\\right)");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
function addSinSquareSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).write("{\\sin\\left(\\right)}^{2}");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
function addCosSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).write("\\cos\\left(\\right)");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
function addCosSquareSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).write("{\\cos\\left(\\right)}^{2}");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
function addTanSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).write("\\tan\\left(\\right)");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
function addTanSquareSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).write("{\\tan\\left(\\right)}^{2}");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
function addCosecSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).write("\\csc\\left(\\right)");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
function addCosecSquareSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).write("{\\csc\\left(\\right)}^{2}");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
function addSecSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).write("\\sec\\left(\\right)");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
function addSecSquareSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).write("{\\sec\\left(\\right)}^{2}");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
function addCotanSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).write("\\cot\\left(\\right)");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
function addCotanSquareSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).write("{\\cot\\left(\\right)}^{2}");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
...
function addPiSymbol(){
 if(lastFocusedMQ == null)return;
 MQ.MathField(document.getElementById(lastFocusedMQ)).cmd("\\pi");
 MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
}
...
function addPhiSymbol(){
 ...
 function addlogbaSymbol(){
  if(lastFocusedMQ == null)return;
  MQ.MathField(document.getElementById(lastFocusedMQ)).write("\\log_b\\left(a\\right)");
  MQ.MathField(document.getElementById(lastFocusedMQ)).focus();
 }
